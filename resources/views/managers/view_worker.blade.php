                            ...
                            <div class="card-body">
                                <div class="author-box-center">
                                    ...
                                    <div class="author-box-name">
                                        <a href="#">{{ isset($user->first_name) ? $user->first_name : '' }}</a>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="py-4">
                                    ...
                                    <p class="clearfix">
                                        ...
                                        <span class="float-right text-muted">{{ isset($user->Worker->architect->first_name) ? $user->Worker->architect->first_name : '' }}</span>
                                    </p>

                                    <p class="clearfix">
                                        <span class="float-left">Sub Contractor</span>
                                ...
                                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#about"
                                            role="tab" aria-selected="true">Documents</a>
                                    </li>
                                </ul>
                                                    ...
                                                    @if (!is_null($user->userDocuments))
                                                        @foreach ($user->userDocuments as $document)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a style="text-decoration:none" data-toggle="modal" data-target="bd-example-modal-lg"
                                                                        onclick="sendData('{{ $document->uploaded_file_url }}')" target="_blank" href="javascript:void(0);">
