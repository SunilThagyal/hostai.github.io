              ...
              <div class="card-body">
                <form id="changePassword" method="POST" action="{{ route('change.password') }}">
                  ...
                  <div class="form-group">
                      ...
                      <input  type="password" class="form-control pwstrength @error('old_password') is-invalid @enderror" data-indicator="pwindicator"
                        name="old_password"  autocomplete="">
                        @error('old_password')
                  ...
                  <div class="form-group">
                      ...
                      <input type="password" name="password" id="cpassword" class="form-control @error('password') is-invalid @enderror" value="">
                      @error('password')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
